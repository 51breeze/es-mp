...
declare function afterEach(callback:(done?:()=>void)=>void):void;
declare function beforeEach(callback:(done?:()=>void)=>void):void;
declare function afterAll(callback:(done?:()=>void)=>void):void;
declare function beforeAll(callback:(done?:()=>void)=>void):void;
